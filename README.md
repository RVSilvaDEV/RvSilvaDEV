...
![header](https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:89B4FA,100:0D1117&height=250&section=header&text=RV%20DEV&fontSize=80&fontColor=FFFFFF&animation=fadeIn&fontAlignY=30&desc=Full%20Stack%20Developer&descSize=18&descAlignY=52&descAlign=50&descColor=CDD6F4)

[![Typing SVG](https://readme-typing-svg.demolab.com/?lines=JavaScript+%7C+TypeScript+%7C+Next.js+%7C+Node.js;Turning+ideas+into+scalable+solutions;Clean+Architecture+%7C+Cybersecurity&font=JetBrains+Mono&center=true&width=520&height=35&color=89B4FA&vCenter=true&size=16&pause=1000&duration=3000)](https://git.io/typing-svg)
...
**Full Stack Developer** focused on building scalable and user-centric digital solutions. I combine clean architecture with performance-driven development to deliver applications that make a real impact.
...
[![GitHub Streak](https://streak-stats.demolab.com/?user=RVSilvaDEV&hide_border=true&background=0D1117&ring=89B4FA&fire=89B4FA&currStreakLabel=89B4FA&sideLabels=CDD6F4&currStreakNum=CDD6F4&sideNums=CDD6F4&dates=585B70)](https://git.io/streak-stats)
...
![footer](https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:89B4FA,100:0D1117&height=150&section=footer)
